...
Quantity.set_axs(quantities, axs[:5])
...
fig.colorbar(mpl.cm.ScalarMappable(norm=norm, cmap=u_s0.cmap),
             orientation='vertical',
             label='$t$', ax=u_s0.ax)
u_s0.label_plot("Leading order displacement", x_label='$x$', label_size='xx-large')
...
# fig.suptitle(f"FEniCS solution with $b_M={b_M_num}$")
# fig.savefig(f"plots/c0_diffusion_sigma/Pe_small_c0_1/fenics_b_M_{b_M_num}_D_m_{D_m_num}.png",
#             bbox_inches='tight')
